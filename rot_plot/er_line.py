...
# 取每行的ER值
cluster_er, icp_er, p2plane_er, robust_er, aa_er, trimmed_er = df.loc[:,['ER','ER.1','ER.2','ER.3','ER.4','ER.5']].values
...
lines = [line_cluster,line_robust,line_aa,line_tr,line_standard]
...
# 标题
file_title = source + ': ER - Rot_degree'
...
# 保存图片
fig_path = './pic/' + source +'/' + source + '_ER_rot_degree.png'
